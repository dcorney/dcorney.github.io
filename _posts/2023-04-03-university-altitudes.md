...
(http://learning-provider.data.ac.uk/) provides a clean CSV files of every university in the UK

And [Get The Data](https://www.getthedata.com/open-postcode-elevation) provides not only a nice searchable index linking locations to altitude, but also lets you download a CSV.

Loading both into Pandas dataframes (for convenience) let me quickly generate a list of all[^1] UK universities sorted by height above sea level. 

+-----------------------------------------------------------+----------------------+------------+
| provider                                                  | town                 |   altitude (m) |
+===========================================================+======================+============+
